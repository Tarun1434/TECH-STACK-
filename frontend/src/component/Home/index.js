      ...
      <div className={`sidebar ${isSidebarOpen ? "active" : ""}`}>
        ...
        <div className="menu-items">
          {menuItems.map(({ text, icon, link }) => (
            <a key={text} href={link} onClick={() => setIsSidebarOpen(false)}>
        ...
        {showCards ? (
          ...
          <>
            <div className="hero-section">
              ...
              <div className="typing-container"><span className="letter-effect">{typingText}</span></div>
            ...
            <div className="features-list">
              {features.map((feature, index) => (
                <div key={index} className="feature-item">
                  <span className="feature-icon"><FaCheckCircle color="#96ff00" /></span>
                  <p>{feature}</p>
                </div>
              ))}
            </div>
